...
% {}{}{}
%    % First key point, etc.
    {Enhancing reduced-gravity model reconstruction in the context of data assimilation using a theory-motivated model error parameterization}{Introducing a physics-derived regularization term for the cost function to enforce multilayer QG dynamics}{Improving the robustness of the model by introducing a deformation radius correcting parameter in the control vector}
...
\begin{abstract}
    ...
    Method validation is performed using two different reference datasets, a three-layer quasi-geostrophic double-gyre simulation and the eNATL60 simulation, both with observations retrieved by an OSSE along SWOT-like tracks.
